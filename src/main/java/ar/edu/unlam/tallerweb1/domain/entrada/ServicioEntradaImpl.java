...
public class ServicioEntradaImpl implements ServicioEntrada {
	...
	@Override
	public void validarEntrada(Funcion funcion, Usuario usuario, List<Asiento> asientos)
			throws DatosEntradaInvalidaException {
	...
	@Override
	public void validarCantidadDeAsientosDisponibles(Funcion funcion, List<Asiento> asientos)
			throws ErrorDeAsientoException {
	...
	private Boolean validarPendiente(Funcion funcion, Usuario usuario) {
		...
		return pendientesDelUsuario == null;
