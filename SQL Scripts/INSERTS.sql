...
insert into usuario (id,email,nombre,password) values
                    ...
                    (2,'juanfrancocamp@gmail.com','Juan','1234'),
...
(21,'David Leitch',125,'2023-06-26 00:00:00','img/peliculas/tren-bala.jpg','Brad Pitt',
...
(23,'Brendan Muldowney',125,'2023-11-30 00:00:00','img/peliculas/escalera-infierno.jpg','Abby Fitz',
...
(24,'Sang-yong Lee',106,'2023-11-25 00:00:00','img/peliculas/fuerza-bruta.jpg','Gwi-hwa Choi',
...
(1,'Susto'),(2,'Pelea'),
(3,'Fascinante'),(4,'Tenebroso'),(5,'Ciencia Ficción'),
(6,'Emoción'),(7,'Animación'),(8,'Informativa'),
(9,'Descriptiva'),(10,'Emotivo'),
(11,'Impactante'),(12,'Tensión'),
(13,'Para niños'),(14,'Historica'),(15,'Interesante'),
(16,'Optimista'),(17,'Emocionante'),(18,'Viaje'),
(19,'Tesoro'),(20,'Fantasia'),(21,'Romantico'),
(22,'Divertida'),(23,'Inquietante'),
(24,'Adultos'),(25,'Acción'),(26,'Drama');  

insert into etiquetapelicula (id,etiqueta_id,pelicula_id) values
                    (1,5,1),(2,17,1),(3,3,1),
                    (5,17,2),(4,2,2),(6,18,2),
                    (7,21,3),(8,15,3),(9,3,3),
					(10,1,4),(11,4,4),(12,23,4),
                    (13,1,5),(14,4,5),(15,23,5),
					(16,1,6),(17,4,6),(18,23,6),
                    (19,8,7),(20,10,7),(21,14,7),
                    (22,8,8),(23,10,8),(24,14,8),
                    (25,2,9),(26,5,9),(27,7,9),
                    (28,24,10),(29,8,10),(30,9,10),
                    (31,8,11),(32,3,11),(33,6,11),
                    (34,13,12),(35,7,12),(36,22,12),
                    (37,1,13),(38,4,13),(39,23,13),
					(40,4,14),(41,2,14),(42,23,14),
					(43,7,15),(44,13,15),(45,3,15),
					(46,7,16),(47,13,16),(48,3,16),
                    (49,12,17),(50,1,17),(51,4,17),
                    (52,1,18),(53,12,18),(54,4,18),
                    (55,19,19),(56,20,19),(57,5,19),
                    (58,25,20),(59,2,20),(60,3,20),
                    (61,25,21),(62,23,21),(63,3,21),
                    (64,3,22),(65,23,22),(66,3,22),
                    (67,1,23),(68,4,23),(69,3,23),
                    (70,2,24),(71,15,24),(72,17,24),
					(73,1,25),(74,4,25),(75,12,25),
                    (76,11,26),(77,23,26),(78,26,26);

 insert into etiquetapelicula (id,etiqueta_id,pelicula_id) values
 (79,4,27),(80,12,27),(81,23,27),
 (82,5,28),(83,20,28),(84,17,28),
 (85,17,29),(86,21,29),(87,20,29),
 (88,4,30),(89,11,30),(90,15,30),
 (91,5,31),(92,7,31),(93,13,31),
 (94,25,32),(95,2,32),(96,3,32),
 (97,4,33),(98,11,33),(99,15,33),
 (100,12,34),(101,1,34),(102,4,34),
 (103,21,35),(104,10,35),(105,3,35),
 (106,3,36),(107,22,36),(108,6,36),
 (109,18,37),(110,23,37),(111,20,37),
 (112,10,38),(113,15,38),(114,21,38),
 (115,14,39),(116,16,39),(117,15,39),
 (118,1,40),(119,4,40),(120,5,40);

insert into valoracion(comentario, puntos, pelicula_id, usuario_id)
values ('Muy buena',5,2,1),('Me gusto',3,2,2),('No me gusto',1,2,3),
       ('Excelente',5,3,1),
